...
const getImages = (query) => {
  ...
  fetch(`https://pixabay.com/api/?key=${KEY}=${query}&image_type=photo&pretty=true`)
    ...
    .catch(err => displayError('Something went wrong.Check your connection'))
}
...
const createSlider = () => {
  ...
  if(duration<=0){
    alert('Please input more than 0 at least!better start with 100');
    imagesArea.style.display = 'block';
...
// Adding spinner function starts here
const toggleSpinner =() =>{
const spinner = document.getElementById('spinner');
// console.log(spinner.classList)
spinner.classList.toggle('d-none');
}
// adding spinner function ends here 

// Error message function starts here 
